...
export default function StatsSlider() {
  const stats = [
    { title: "Total Agents", value: "152", icon: "👤" },
    { title: "Active Agents", value: "87", icon: "✅" },
    { title: "Total Tasks", value: "2,365", icon: "📋" },
    { title: "Completed Tasks", value: "1,894", icon: "✔️" },
    { title: "Task Efficiency", value: "80%", icon: "📊" },
  ];
